...
// public function jointhreetables($column_names,$table1,$table2,$table3, $columnEqual,$columnEqual2){
// 	$connectthree=$this->dal->joinTables("SELECT ".$column_names." FROM ".$table1." INNER JOIN ".$table3." ON ".$columnEqual.
// 	 "INNER JOIN ".$table2." ON ".$columnEqual2);
// 	return $connectthree;
// }
